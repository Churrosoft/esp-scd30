 ...
 *
 ...
 Changes January 2021 alogra anaire.org
  * Deactivated autocalibration at the begining
  * Integrated with getAutoSelfCalibration from Sparkfun library
...
class SCD30
{
  public:
		...
		// alogra
		boolean getAutoSelfCalibration(void);
